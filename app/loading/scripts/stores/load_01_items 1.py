...
directory = Path(r"C:\Users\hp\Desktop\internship\erp-fastapi\app\loading\data\items")
...
ITEM_COLUMNS = ["item_code", "name", "default_specification", "default_unit_of_measurement", "category", "is_active", "is_verified"]
