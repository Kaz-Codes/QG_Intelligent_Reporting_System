...
from app.imports.consignment_helpers import create_consignment_item_object, create_consignment_object, create_payment_object
...
def create_consignment(
    ...
    try:
        ...
        consignment = create_consignment_object(consignment_data)
